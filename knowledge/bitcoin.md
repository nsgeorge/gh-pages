...
最初に相手のビットコインアドレス（公開鍵）を指定し、そのビットコインアドレスに対していくらのビットコインを送金するかを指定します。
...
実はこの概念はかなり重要です。というのも、「公開鍵に対応する秘密鍵を持つ人」というのは人が誰かは限定していません。
つまり、この秘密鍵を持っている人なら誰でも使えてしまうという意味になります。
このため、秘密鍵が流出してしまうと大変なことになります。
