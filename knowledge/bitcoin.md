...
この皆が手元に持っている公開された元帳こそが「ブロックチェーン」を指します。
...
実は、ブロックハッシュには先頭に0がN個続かないといけないというルールがあります。
このNは時期によって変動します。2018年7月現在は、0が18個続く必要があるようです。
...
この図のように、nonceの値を変えながらブロックハッシュが「偶然0がN個連続するハッシュ値」になるまで
ひたすら計算を繰り返します。これが俗にいう「マイニング」という作業になります。
