---
layout: default
description: ビットコインで利用されているブロックチェーン技術について具体的な事例を使って徹底解説します。トランザクション、ウォレット、マイニングなどもすっきり分かるようになります。
---

# ビットコイン／ブロックチェーン 徹底解説
...
**※ 間違いや指摘がありましたら、本リポジトリのIssue（トップの右上から飛べます）にコメント頂けると助かります。**
...
|ウォレット|トランザクションのアウトプット利用や電子署名に利用するためのキーペア群|
...
これに対し、2008年に中本サトシという人物が新しい電子決済システムを提案しました。

 - [Bitcoin: A Peer-to-Peer Electronic Cash System](https://bitcoin.org/bitcoin.pdf)

これがビットコインです。
この論文で説明されているビットコインの仕組みは、
まさに上で出てきたビザンチン将軍問題を解決するような内容でした。
